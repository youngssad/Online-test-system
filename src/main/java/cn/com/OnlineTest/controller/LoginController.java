...
import cn.com.OnlineTest.dao.ClassDao;
import cn.com.OnlineTest.model.Pjclass;
import cn.com.OnlineTest.model.Users;
import cn.com.OnlineTest.dao.UsersDao;
...
public class LoginController {
            ...
            if(userpwd.equals("")){
               wk = "Password cant be empty！";
                ...
                if (truename.equals("")){
                    ...
                    cg = "Register successfully, please login！";
    ...
    private String zclogout(HttpServletRequest request){
        HttpSession session = request.getSession(true);
        System.out.println("Session clear successfully！");
